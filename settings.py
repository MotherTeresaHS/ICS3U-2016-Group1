...
class SettingsScene(Scene):
    def setup(self):
        ...
        self.game_label = LabelNode(text = 'Settings',
                                     font=('Markerfelt-Wide', 40),
                                     parent = self,
                                     position = (self.size_of_screen_x - 80, self.size_of_screen_y - 40),
                                     color = 'grey')
        ...
        self.help_text = LabelNode(text = 'settings is currently being worked on.',
